...
try:
    solution_to_use_input = raw_input ("Select the solution(s) to spray with (A,B,C or rinse) (default: A)\n")
    solution_to_use = []
...
try:
    ...
    for i in range(len(solution_to_use)):
        try:
            coordinates_of_spray_x_axis_1 = float(raw_input ("Set the first x-axis coordinates of spraying (default: -60) (solution %s)\n" %(solution_to_use_letter[i])))
        except:
            coordinates_of_spray_x_axis_1 = float(-60)
        try:
            coordinates_of_spray_x_axis_2 = float(raw_input ("Set the second x-axis coordinates of spraying (default: 60) (solution %s)\n" %(solution_to_use_letter[i])))
        except:
            coordinates_of_spray_x_axis_2 = float(60)
        try:
            coordinates_of_spray_y_axis_1 = float(raw_input ("Set the first y-axis coordinates of spraying (default: -80) (solution %s)\n" %(solution_to_use_letter[i])))
        except:
            coordinates_of_spray_y_axis_1 = float(-80)
        try:
            coordinates_of_spray_y_axis_2 = float(raw_input ("Set the second y-axis coordinates of spraying (default: 80) (solution %s)\n" %(solution_to_use_letter[i])))
        except:
    ...
    try:
        coordinates_of_spray_x_axis1 = float(raw_input ("Set the first x-axis coordinates of spraying (default: -60) (solution %s)\n" %(solution_to_use_letter)))
    except:
        coordinates_of_spray_x_axis1 = float(-60)
    try:
        coordinates_of_spray_x_axis2 = float(raw_input ("Set the second x-axis coordinates of spraying (default: 60) (solution %s)\n" %(solution_to_use_letter)))
    except:
        coordinates_of_spray_x_axis2 = float(60)
    try:
        coordinates_of_spray_y_axis1 = float(raw_input ("Set the first y-axis coordinates of spraying (default: -80) (solution %s)\n" %(solution_to_use_letter)))
    except:
        coordinates_of_spray_y_axis1 = float(-80)
    try:
        coordinates_of_spray_y_axis2 = float(raw_input ("Set the second y-axis coordinates of spraying (default: 80) (solution %s)\n" %(solution_to_use_letter)))
    except:
...
try:
    ...
    for i in range(len(solution_to_use)):
        try:
            height_of_the_needle_input = float(raw_input ("Set the height of the needle (default: 60) (solution %s)\n" %(solution_to_use_letter[i])))
            height_of_the_needle.append(height_of_the_needle_input)
        except:
            height_of_the_needle.append(float(60))
except:
    try:
        height_of_the_needle = float(raw_input ("Set the height of the needle (default: 60) (solution %s)\n" %(solution_to_use_letter)))
    except:
...
try:
    ...
    for i in range(len(solution_to_use)):
        try:
            distance_between_lines_input = float (raw_input ("Set the distance between lines when spraying (default: 5) (solution %s)\n" %(solution_to_use_letter[i])))
            distance_between_lines.append(distance_between_lines_input)
        except:
            distance_between_lines.append(float(5))
except:
    try:
        distance_between_lines = float (raw_input ("Set the distance between lines when spraying (default: 5) (solution %s)\n" %solution_to_use_letter))
    except:
...
try:
    ...
    for i in range(len(solution_to_use)):
        try:
            speed_of_movement_input = float (raw_input ("Set the speed of movement (max: 200, default: 150) (solution %s)\n" %(solution_to_use_letter[i])))
            speed_of_movement.append(speed_of_movement_input)
        except:
            speed_of_movement.append(float(150))
except:
    try:
        speed_of_movement = float (raw_input ("Set the speed of movement (max: 200, default: 150) (solution %s)\n" %solution_to_use_letter))
    except:
...
try:
    ...
    for i in range(len(solution_to_use)):
        try:
            matrix_density_input = float (raw_input ("Set the density of the matrix on-tissue (in microlitres per squared centimeter) (max: 5, default: 1) (solution %s)\n" %(solution_to_use_letter[i])))
            matrix_density.append(matrix_density_input)
        except:
            matrix_density.append(float(1))
except:
    try:
        matrix_density = float (raw_input ("Set the density of the matrix on-tissue (in microlitres per squared centimeter) (max: 5, default: 1) (solution %s)\n" %solution_to_use_letter))
    except:
...
try:
    ...
    for i in range(len(solution_to_use)):
        try:
            number_of_spray_cycles_input = int (raw_input ("Set the number of spraying cycles (default:2) (solution %s)\n" %(solution_to_use_letter[i])))
            number_of_spray_cycles.append(number_of_spray_cycles_input)
        except:
            number_of_spray_cycles.append(2)
except:
    try:
        number_of_spray_cycles = int (raw_input ("Set the number of spraying cycles (default:2) (solution %s)\n" %solution_to_use_letter))
    except:
...
try:
    ...
    for i in range(len(solution_to_use)):
        try:
            additional_waiting_time_after_each_spray_cycle_input = float (raw_input ("Set the additional time (in seconds) to wait after each spraying cycle (default:0) (solution %s)\n" %(solution_to_use_letter[i])))
    ...
    try:
        additional_waiting_time_after_each_spray_cycle = float (raw_input ("Set the additional time (in seconds) to wait after each spraying cycle (default:0) (solution %s)\n" %solution_to_use_letter))
    except:
...
try:
    ...
    for i in range(len(solution_to_use)):
        try:
            horizontal_spraying_input = raw_input ("Spray horizontally? (y or n, default: y) (solution %s)\n" %(solution_to_use_letter[i]))
    ...
    try:
        horizontal_spraying = raw_input ("Spray horizontally? (y or n, default: y) (solution %s)\n" %solution_to_use_letter)
